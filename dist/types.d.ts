...
export type TTypographyListItemProps<TStyle = Record<string, any>, TChildren = any> = TTypographyProps<TStyle, TChildren> & {
    content: string;
};
export type TTypographyBlockquoteProps<TStyle = Record<string, any>, TChildren = any> = TTypographyProps<TStyle, TChildren> & {
    citation?: string;
